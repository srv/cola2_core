...
* `cola2_log`: avoid problematic typing in `cola2_version_node`.

## [24.1.5] - 26-06-2024

* `cola2_control`: fixed captain stale when mission actions are not present in the service server.
* `cola2_sim`: fixed battery status simulation.
